...
def permanent_pin_set(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    if prev_message and is_group:
        ...
        update.effective_message.reply_text(tl(update.effective_message, "Permanent pin successfully set!"))
        return "<b>{}:</b>" \
               "\n#PERMANENT_PIN" \
