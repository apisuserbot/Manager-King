...
from emilia import dispatcher, SUDO_USERS, OWNER_USERNAME, OWNER_ID
from emilia.modules.helper_funcs.extraction import extract_user
from emilia.modules.helper_funcs.chat_status import bot_admin


@bot_admin
@run_async
def addsudo(bot: Bot, update: Update, context, *args: List[str]):
    args = context.args
...
@bot_admin
@run_async
def rsudo(bot: Bot, update: Update, context, *args: List[str]):
    args = context.args
    message = update.effective_message
    user_id = extract_user(message, args)
